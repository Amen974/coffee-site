...
const BestSell = () => {
  return (
    <section id='BestSell'>
      ...
      <div className='bg-black bg-no-repeat bg-contain bg-left h-[45vh] flex items-center justify-center max-sm:h-[30vh] max-sm:bg-cover max-md:h-[80vh]'style={{ backgroundImage: 'url("imgs/coffee-beans-left.png")' }}>
        <div className='flex items-center justify-center gap-11'>
          <div>
            <a href=""><img src="/imgs/americano (1).jpg" alt="" className='h-[190px] rounded-full max-sm:h-[135px]'/></a>
          </div>
      ...
      <div className='bg-black bg-no-repeat bg-contain bg-right h-[45vh] flex items-center justify-center max-sm:h-[30vh] max-sm:bg-cover max-md:h-[80vh]'style={{ backgroundImage: 'url("imgs/coffee-beans-right.png")' }}>
        <div className='text-white max-sm:flex-1'>
        ...
        <div>
          <a href=""><img src="/imgs/Cortado.jpg" alt="" className='h-[190px] rounded-full max-sm:h-[135px]'/></a>
        </div>
      </div>
      ...
      <div className='bg-black bg-no-repeat bg-contain bg-left h-[45vh] flex items-center justify-center max-sm:h-[30vh] max-sm:bg-cover max-md:h-[80vh]'style={{ backgroundImage: 'url("imgs/coffee-beans-left.png")' }}>
        <div className='flex items-center justify-center gap-11'>
          <div>
            <a href=""><img src="/imgs/creamy latte.jpg" alt="" className='h-[190px] rounded-full max-sm:h-[135px]'/></a>
          </div>
          <div className='text-white max-sm:flex-1'>
