const Hero = () => {
  return (
    <section id="Hero" className="h-[100vh] max-md:h-[110vh] max-sm:h-[80vh] bg-no-repeat bg-cover bg-center flex justify-center items-center" style={{ backgroundImage: 'url("/imgs/coffee-beans-1.jpg")' }}>
