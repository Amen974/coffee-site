...
const Hero = () => {
  ...
  return (
    <section
      ...
      style={{ backgroundImage: 'url("imgs/coffee-beans-1(1).png")' }}
    >
      <div className="flex flex-col items-center max-w-162 max-md:max-w-125">
        ...
        <p className="text-2xl text-white max-md:text-[19px] max-md:mb-0 opacity-0 translate-y-10 hero-p">
          A unique world of flavers
        </p>
        <p className="text-white text-[1rem] text-center mb-6 hero-p">
        ...
        <div className="flex gap-4 justify-center items-center mt-1 mb-7 max-md:mb-2 hero-p">
          <HashLink
            to="#Menu"
