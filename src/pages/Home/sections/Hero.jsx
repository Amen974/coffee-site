  ...
  return (
    ...
    >
      <div className="flex flex-col items-center max-w-162 max-md:max-w-125">
        <h1 className="text-red-600 font-dancing font-bold text-7xl mb-2 max-md:text-5xl max-md:mb-0">
          A sip of joy
        </h1>
        <p className="text-2xl text-white mb-4 max-md:text-[19px] max-md:mb-0">
          A unique world of flavers
        </p>
        <p className="text-white text-[1rem] text-center mb-6">
